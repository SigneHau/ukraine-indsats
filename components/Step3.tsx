...
export default function Step3({ onNext, onBack, initialData, userType }: Step3Props) {
  ...
  // STATS: Her husker computeren køn, navn og fødselsdagsdata mens der tastes
    ...
    <div className="flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-500 w-full pb-20 text-center">
      <div className="max-w-2xl w-full">
        ...
        <div className="mb-8">
          {userType === "self" && (
            <>
              <h1 className="text-navy text-3xl md:text-4xl font-normal mb-2 uppercase tracking-tight font-kbh">
                Про себе
              </h1>
        ...
        <div className="flex items-center justify-between w-full max-w-md mx-auto px-2">
          ...
          <Button variant="purple" size="kk" onClick={handleNext} className="h-14 px-10 shadow-xl flex flex-col items-center justify-center border-none cursor-pointer">
