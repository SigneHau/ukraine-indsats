            ...
            {steps.map((step, index) => (
              <div key={index} className="flex md:flex-col items-start md:items-center text-left md:text-center group relative">
                ...
                <div className="flex flex-col items-center mr-6 md:mr-0 md:mb-4 shrink-0 relative">
                  ...
                  {/* LODRET LINJE (MOBIL) - Din version der virker perfekt */}
                  {index !== steps.length - 1 && (
                    <div className="absolute left-1/2 top-20 h-[120%] max-h-[calc(100%+6px)] w-0 border-l-2 border-dashed border-secondary-light md:hidden -translate-x-1/2 z-0" />
                  )}
